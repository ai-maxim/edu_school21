...
/*   Updated: 2021/04/22 19:16:28 by qdong            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_close			sp_intersect_0(t_vec *orig, t_vec *dir,
					void *data, double lim[2]);
t_close			sp_intersect_1(t_vec *orig, t_vec *dir,
					void *data, double lim[2]);
t_close			sp_intersect(t_vec *orig, t_vec *dir,
					void *data, double lim[2]);
t_close			pl_intersect(t_vec *orig, t_vec *dir,
					void *data, double lim[2]);
t_close			cy_intersect(t_vec *orig, t_vec *dir,
					void *data, double lim[2]);
t_close			sq_intersect(t_vec *orig, t_vec *dir,
					void *data, double lim[2]);
...
t_close			tr_intersect(t_vec *orig, t_vec *dir,
					void *data, double lim[2]);
